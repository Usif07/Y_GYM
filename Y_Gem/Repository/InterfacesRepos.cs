...
namespace Y_GYM.Repository
{
    ...
    public class CheckInRepository : GenericRepository<CheckIn>, ICheckInRepository
    {
        ...
        public IEnumerable<CheckIn> GetAllWithDetails()
        {
            return _context.Set<CheckIn>()
                .Include(c => c.Member)
                .Include(c => c.Staff)
        ...
        public class ProgressRepository : GenericRepository<Progress>, IProgressRepository
        {
            ...
            public IEnumerable<Progress> GetAllWithDetails()
            {
        ...
        public class ClassScheduleRepository
            : GenericRepository<ClassSchedule>, IClassScheduleRepository
        {
        ...
        public class DietPlanRepository
            : GenericRepository<DietPlan>, IDietPlanRepository
        {
